...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_personalization_profiles_user_id'), table_name='personalization_profiles', if_exists=True)
    op.drop_table('personalization_profiles', if_exists=True)
    op.drop_index(op.f('ix_reports_user_id'), table_name='reports', if_exists=True)
